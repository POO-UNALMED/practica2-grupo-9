...
public class Writer {
	...
	public static void Write() {
		...
		try {// Facturas
			...
			outputs = new ObjectOutputStream(new FileOutputStream(PATH.getAbsolutePath() + "\\src\\BaseDatos\\temp\\Abarrote.txt"));
			...
			outputs = new ObjectOutputStream(new FileOutputStream(PATH.getAbsolutePath() + "\\src\\BaseDatos\\temp\\Aseo.txt"));
			...
			outputs = new ObjectOutputStream(new FileOutputStream(PATH.getAbsolutePath() + "\\src\\BaseDatos\\temp\\Factura.txt"));
			...
			outputs = new ObjectOutputStream(new FileOutputStream(PATH.getAbsolutePath() + "\\src\\BaseDatos\\temp\\Juguete.txt"));
